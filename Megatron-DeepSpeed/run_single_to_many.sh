...
# =================================================================
# PHASE 1A: ZeRO-1 SOURCE (TP=1, PP=1, DP=4) + convert
# =================================================================
Z1_SOURCE_NAME="source_tp1_pp1_dp4_sp1_z1"
...
echo ">>> [PHASE 1A] Train ZeRO-1 source (TP=1, PP=1, DP=4)..."
...
# # =================================================================
# # PHASE 2B: ZeRO-2 TARGETS (4 GPUs, SP=1) - requires --no-pipeline-parallel [web:7]
# # =================================================================
# TARGET_CONFIGS_Z2=(
#   "1 1 4"  # TP=1, PP=1, DP=4
#   "2 1 2"  # TP=2, PP=1, DP=2
# )
